...
-   If you are joining as a Work-Study Research Assistant, you must also complete the required WorkSafeBC health and safety training for the following online courses:  (1) Health & Safety Orientation; (2) Awareness and Prevention of Workplace Bullying, Harassment & Discrimination available from the [University of Victoria’s Occupational Health, Safety & Environment website](https://www.uvic.ca/ohse/
) (see the [training page](https://www.uvic.ca/ohse/training/index.php) specifically). You can count those (and the TCPS-2 CORE course) as work hours.  Also, you can consider listing completion of these courses on your resume.  
