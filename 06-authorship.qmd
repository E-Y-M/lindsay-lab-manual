...
The American Psychological Association (APA) provides some [useful resources](https://psychology.nd.edu/assets/198758/ContractWorksheet.pdf) regarding authorship determination and "tiebreaking" when contributions are almost equal, but projects vary widely enough that adhering to a [scoring system](https://www.siue.edu/graduate/pdf/authorship-determination-scorecard.pdf) does not always make sense. The following are contributions that would usually merit authorship credit (inspired in part by the APA recommendations):
