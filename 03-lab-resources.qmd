...
The lab’s graduate student office is located in Cornett A193 and has desk room and desktop PCs with 2 monitors for two students. These are generally available for use by honours students and research assistants on a drop-in basis as long as the room is open. Please do not install software on lab computers without express permission from Prof. Lindsay or the Lab Manager.

We have two individual participant testing rooms located in Cornett A178 and A179. Both are currently equipped with lab laptops and VR equipment. Although these rooms are primarily used for running VR experiments, they are also available for student use when they are not occupied for the purpose of participant testing. Reserving these rooms for either purpose can be done by checking in with other lab members on Teams.
...
For running online experiments, the lab occasionally has access to a Qualtrics Survey Software license. See [this site](https://www.qualtrics.com/support/survey-platform/getting-started/survey-platform-overview/) and [this video](https://www.youtube.com/watch?v=Tp5mvAWYtBE) for useful tutorials on designing Qualtrics surveys and experiments for psychological research.
